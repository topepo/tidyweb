...
```{r, echo = FALSE}
pkgs <- sort(c("haven", "stringr", "forcats", "readr"))

imgs <- paste0(
  "<a href='http://", pkgs, ".tidyverse.org'>",
  "<img src='https://github.com/tidyverse/", pkgs, "/raw/master/logo.png'",
  " width='120' height='139' /></a>"
)
